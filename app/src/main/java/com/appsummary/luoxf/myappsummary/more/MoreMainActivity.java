...
package com.appsummary.luoxf.myappsummary.more;
...
import com.appsummary.luoxf.myappsummary.more.smsobserver.SmsObserverActivity;
...
public class MoreMainActivity extends BaseActivity {
    ...
    public static final String ITEMSTR_SMSOBSERVERLIBRARY = "smsObserverLibrary";
    private static List<Integer> colorList = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        initToolBarWithBack(R.string.title_more);
        ...
        adapter.setOnItemClickListener(new MyItemClickListener() {
            ...
            public void onItemClick(View view, String data) {
                switch (data) {
                    case ITEMSTR_SMSOBSERVERLIBRARY:
                        startActivity(new Intent(MoreMainActivity.this, SmsObserverActivity.class));
                        break;
                    default:
                        break;
                }
    ...
    private static class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> implements View.OnClickListener {
        ...
        private void initListItem() {
            initItemModel(ITEMSTR_SMSOBSERVERLIBRARY, mContext.getString(R.string.sub_summary_smsobserver));
        }
