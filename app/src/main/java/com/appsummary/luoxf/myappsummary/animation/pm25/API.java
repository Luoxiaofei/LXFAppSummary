...
public abstract interface API {
	...
	public static final String PM25API = "http://www.pm25.in/api/querys/aqi_details.json?token=4esfG6UEhGzNkbszfjAp&city=%s&stations=yes";
	//http://www.pm25.in/api/querys/aqi_details.json?token=4esfG6UEhGzNkbszfjAp&city=shenzhen&stations=yes
	public static final String PM25FeedbackAPI = "http://www.pm25.in/api/update/feedback.json?token=4esfG6UEhGzNkbszfjAp&city";
