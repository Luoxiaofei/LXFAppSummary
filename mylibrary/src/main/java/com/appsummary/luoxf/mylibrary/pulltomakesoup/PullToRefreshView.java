package com.appsummary.luoxf.mylibrary.pulltomakesoup;
...
import com.appsummary.luoxf.mylibrary.R;
import com.appsummary.luoxf.mylibrary.pulltomakesoup.refresh_view.SoupRefreshView;
import com.appsummary.luoxf.mylibrary.pulltomakesoup.utils.Utils;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mFirstY < ev.getY() && yDiff > mTouchSlop && !mIsBeingDragged) {
